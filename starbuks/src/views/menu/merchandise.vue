      ...
      <header>
        ...
        <span>商品</span>
      	...
      	<div id="sliderSegmentedControl" class="mui-scroll-wrapper mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
            ...
            <a class="mui-control-item"  @click="getByCateId('ordinary')">常规商品</a>
            <a class="mui-control-item"  @click="getByCateId('premium')">甄选商品</a>
      		</div>
      	</div>
    </div>
...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      getByCateId(val){
        this.$http.get('http://123.56.129.223/starbucks/menu.php?category=merchandise&type='+val).then(res=>{
          this.list = res.data
