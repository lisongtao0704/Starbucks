<template>
	<article class="nav-overlay menu-page">
		<div class="nav-container">
			<nav-header-overlay @clickedCloseMenu="closeMenu"></nav-header-overlay>
			<nav-body-overlay></nav-body-overlay>
			<nav-footer-overlay></nav-footer-overlay>
		</div>
	</article>
</template>
<script>
